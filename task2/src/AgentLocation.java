...
public class AgentLocation {
	...
	public Agent detect(AgentDetector detector) {
		for (Agent a : agents) {
			if (detector.inView(a))
				return a;
		}
		return null;
	}
	...
	public static void main(String[] args) {
		Viewer _viewer = new Viewer("C:\\Users\\Richard\\Google Drive\\EWU\\CSCD480 Intelligent Systems\\workspace\\task2\\tracks\\task2_location_test.trk", 10);
