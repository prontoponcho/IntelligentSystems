...
public class Course {
	...
	public void smooth() {
		while (true) {
			...
			ArrayList<Integer> coordsToSmooth = new ArrayList<Integer>();
			smooth(coordsToSmooth);
			
			if (coordsToSmooth.size() == 0) break; 
			
			for(int i : coordsToSmooth) {
	...
	//helper function
	private void smooth(ArrayList<Integer> coordsToSmooth) {
   ...
   public static Course segmentedCourse(int size) {
